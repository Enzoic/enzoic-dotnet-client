...
namespace EnzoicClient.Utilities
{
    public static class Hashing
    {
        ...
        {
            return Crypter.Phpass.Crypt(password, salt);
        }
        ...
        {
            return MD5Crypter.MD5.Crypt(Encoding.UTF8.GetBytes(password), salt);
        }
        ...
        {
            return TraditionalDesCrypter.TraditionalDes.Crypt(Encoding.UTF8.GetBytes(password), salt);
        }
