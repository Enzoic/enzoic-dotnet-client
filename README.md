...
Console.WriteLine("First password for eicar_0@enzoic.com was " + userPasswords.Passwords[0].Password);
```
...
The Enzoic.GetUserPasswords method returns the response object below.
...
```
Each password is returned in a PasswordDetails object:
